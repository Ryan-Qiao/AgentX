...
* Markdown / TXT / PDF / Word / PPT / Excel / HTML / CSV / JSON / XML 多格式导入
* MarkItDown 转 Markdown 后统一解析、分块
* Embedding 生成并落库
* pgvector 相似度检索（`<->`）
...
```bash
# 1. 克隆仓库
git clone git@github.com:Ryan-Qiao/AgentX.git
cd AgentX

# 2. 安装后端/AI/RAG 依赖
brew install postgresql@17 pgvector ollama node
brew services start postgresql@17
brew services start ollama
ollama pull bge-m3

# 3. 安装 MarkItDown（推荐 uv tool）
brew install uv
